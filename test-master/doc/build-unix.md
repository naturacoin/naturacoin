UNIX BUILD NOTES
====================
Some notes on how to build naturacoin in Unix. 
...
This will build naturacoin-qt as well if the dependencies are met.
...
If you want to build naturacoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a naturacoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip naturacoind" to strip the debug
