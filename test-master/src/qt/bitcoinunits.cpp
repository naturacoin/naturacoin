...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MNAT);
    unitlist.append(kNAT);
    unitlist.append(NAT);
    unitlist.append(NATtoid);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MNAT: return QString("MNAT");
    case kNAT: return QString("kNAT");
    case NAT: return QString("NAT");
    case NATtoid: return QString("NATtoid");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MNAT: return QString("Mega-naturacoin (1,000,000 NAT)");
    case kNAT: return QString("Kilo-naturacoin (1000 NAT)");
    case NAT: return QString("naturacoin");
    case NATtoid: return QString("NATtoid (1 / 100,000,000");
    default: return QString("???");
    }
}
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MNAT: return Q_INT64_C(100000000000000);
    case kNAT: return Q_INT64_C(100000000000);
    case NAT:  return Q_INT64_C(100000000);
    case NATtoid: return Q_INT64_C(1);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MNAT: return Q_INT64_C(900000);
    case kNAT: return Q_INT64_C(900000000);
    case NAT:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
    case NATtoid: return Q_INT64_C(9000000000000000000); // Slightly under max value for int64
    default:   return 0;
    }
}
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MNAT: return 6;  // 900,000 (# digits, without commas)
    case kNAT: return 9;  // 900,000,000
    case NAT:  return 12; // 900,000,000,000
    case NATtoid: return 19; // 9,000,000,000,000,000,000
    default: return 0;
    }
}
