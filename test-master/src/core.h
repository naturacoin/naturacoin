...
static const int64_t MAX_MONEY = 100000 * COIN; // naturacoin: maximum of 100K coins, max transaction 100K
...
public:
    ...
    {
        // naturacoin: IsDust() detection disabled, allows any valid dust to be relayed.
